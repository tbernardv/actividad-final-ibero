        ...
        <div class="tab-class text-center wow fadeInUp" data-wow-delay="0.1s">
            ...
            <div class="tab-content">
                <div id="tab-1" class="tab-pane fade show p-0 active">
                    <div class="row g-4">
                        @foreach ($breakfastFoods as $breakfast )
                            <div class="col-lg-6">
                                <div class="d-flex align-items-center">
                                    <img class="flex-shrink-0 img-fluid rounded" src="{{ asset('assets/img/'.$breakfast->image.'') }}" alt="" style="width: 80px;">
                                    <div class="w-100 d-flex flex-column text-start ps-4">
                                        <h5 class="d-flex justify-content-between border-bottom pb-2">
                                            <span>{{ $breakfast->name }}</span>
                                            <span class="text-primary">${{ $breakfast->price }}</span>
                                        </h5>
                                        <small class="fst-italic">{{ substr($breakfast->description, 0, 70) }}</small>
                                        <a type="button" href="{{ route('food-details', $breakfast->id) }}" class="btn btn-primary py-2 top-0 end-0 mt-2 me-2">view</a>
                                    </div>
                                </div>
                            </div>
                        @endforeach
                            ...
                            <div class="col-lg-6">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="w-100 d-flex flex-column text-start ps-4">
                                        ...
                                        <small class="fst-italic">{{ substr($lunch->description, 0, 70) }}</small>
                                        <a type="button" href="{{ route('food-details', $lunch->id) }}" class="btn btn-primary py-2 top-0 end-0 mt-2 me-2">view</a>
                                    </div>
                                </div>
                            </div>     
                        @endforeach
                            ...
                            <div class="col-lg-6">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="w-100 d-flex flex-column text-start ps-4">
                                        ...
                                        <a type="button" href="{{ route('food-details', $dinner->id) }}" class="btn btn-primary py-2 top-0 end-0 mt-2 me-2">view</a>
                                    </div>
                                </div>
                            </div>
                        @endforeach
    ...
    <div class="row g-0">
        ...
        <div class="col-md-6 bg-dark d-flex align-items-center">
            <div class="p-5 wow fadeInUp" data-wow-delay="0.2s">
                ...
                <form method="POST" action="{{ route('food-booking-tables') }}">
                    @csrf
                    <div class="row g-3">
                        <div class="col-md-6">
